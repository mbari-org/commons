...
public class MatlibTest {
    ...
    public void nearInclusiveTest() {
        ...
        assertTrue(
                Matlib.near(a, 10, true) == -1,
                () -> "Value was outside the array and should have been null.");
        assertTrue(
                Matlib.near(a, -1, true) == -1,
                () -> "Value was outside the array and should have been null.");
        ...
        //        assertNull("Value was outside the array and should have been null.",
        // Matlib.nearInclusive(a, 10));
        //        assertNull("Value was outside the array and should have been null.",
        // Matlib.nearInclusive(a, -1));
    ...
    public void testLogspace() {
        ...
        for (int i = 0; i < actualResult.length; i++) {
            assertEquals(expectedResult[i], actualResult[i], 0.0000000001D);
        }
    }
    ...
    public void testMedian() {
        ...
        assertEquals(expectedMedian1, median1, 0.0000000001D);
        double median2 = Statlib.median(values2);
        assertEquals(expectedMedian2, median2, 0.0000000001D);
    }
    ...
    public void testVariance() {
        ...
        assertEquals(expectedValue, var, 0.000000001D);
    ...
    public void testStd() {
        ...
        std = Statlib.standardDeviation(values);
        assertEquals(expectedValue, std, 0.0000000001D);
    }
    ...
    public void testPearsonsCorrelation() {
        ...
        assertEquals(expectedValue, cc, 0.0000001D);

        cc = Statlib.pearsonsCorrelation(values, values);
        assertEquals(1D, cc, 0.0000001D);
        var dd = cc;
        assertTrue(
                (cc <= 1) && (cc >= -1),
                () ->
                        "Correlation Coefficient is not in the expected range: -1 <= "
                                + dd
                                + " <= 1");
    }
}
