...
public class Seawater {
    ...
    /**
     * Conductivity of 42.914 [mmho cm :sup:`-1` == mS cm :sup:`-1`] at Salinity 35 psu, Temperature
     * 15 :math:`^\\circ` C [ITPS 68] and Pressure 0 db.
     *
     * <p>References ---------- .. [1] R.C. Millard and K. Yang 1992. "CTD Calibration and
     * Processing Methods used by Woods Hole Oceanographic Institution" Draft April 14, 1992
     * (Personal communication).
     *
     * <p>See also (Culkin and Smith, 1980; UNESCO, 1983.)
     */
     ...
     *
     * <p>1 sidereal day = 23.9344696 hours
     *
     * <p>Changed to a more precise value at Groten 2004
     *
     * <p>References ---------- .. [1] A.E. Gill 1982. p.54 eqn 3.7.15 "Atmosphere-Ocean Dynamics"
     * Academic Press: New York. ISBN: 0-12-283522-0. page: 597 .. [2] Groten, E., 2004: Fundamental
     * Parameters and Current (2004) Best Estimates of the Parameters of Common Relevance to
     * Astronomy, Geodesy, and Geodynamics. Journal of Geodesy, 77, pp. 724-797.
     */
    ...
    /**
     * The Celcius zero point; 273.15 K. That is T = t + T0 where T is the Absolute Temperature (in
     * degrees K) and t is temperature in degrees C.
     */
    private static double T0 = 273.15;

    /**
     * Mole-weighted average atomic weight of the elements of Reference-Composition sea salt, in
     * units of kg mol :sup:`-1`. Strictly speaking, the formula below applies only to seawater of
     * Reference Composition. If molality is required to an accuracy of better than 0.1% we suggest
     * you contact the authors for further guidance.
     */
    private static double MS = 0.0314038218;

    /**
     * The "specific heat" for use with Conservative Temperature. cp0 is the ratio of potential
     * enthalpy to Conservative Temperature. See Eqn. (3.3.3) and Table D.5 from IOC et al. (2010).
     */
     ...
     *
     * <p>SSO is the best estimate of the Absolute Salinity of Standard Seawater when the seawater
     * sample has a Practical Salinity, SP, of 35 (Millero et al., 2008), and this number is a
     * fundamental part of the TEOS-10 definition of seawater.
     *
     * <p>References: ----------- .. [1] IOC, SCOR and IAPSO, 2010: The international thermodynamic
     * equation of seawater - 2010: Calculation and use of thermodynamic properties.
     * Intergovernmental Oceanographic Commission, Manuals and Guides No. 56, UNESCO (English), 196
     * pp. See appendices A.3, A.5 and Table D.4.
     *
     * <p>.. [2] Millero, F. J., R. Feistel, D. G. Wright, and T. J. McDougall, 2008: The
     * composition of Standard Seawater and the definition of the Reference-Composition Salinity
     * Scale, Deep-Sea Res. I, 55, 50-72. See Table 4 and section 5.
     */
    ...
    /**
     * The ratio of Practical Salinity, SP, to Chlorinity, 1.80655 kg/g for Reference Seawater
     * (Millero et al., 2008). This is the ratio that was used by the JPOTS committee in their
     * construction of the 1978 Practical Salinity Scale (PSS-78) to convert between the laboratory
     * measurements of seawater samples (which were measured in Chlorinity) to Practical Salinity.
     *
     * <p>References: ----------- .. [1] Millero, F. J., R. Feistel, D. G. Wright, and T. J.
     * McDougall, 2008: The composition of Standard Seawater and the definition of the
     * Reference-Composition Salinity Scale, Deep-Sea Res. I, 55, 50-72. See section 5 below Eqn.
     * (5.5).
     */
    ...
    /**
     * This function returns the mole-weighted atomic weight of sea salt of Reference Composition,
     * which is 31.4038218 g/mol. This has been defined as part of the Reference-Composition
     * Salinity Scale of 2008 (Millero et al., 2008).
     *
     * <p>References: ----------- .. [1] IOC, SCOR and IAPSO, 2010: The international thermodynamic
     * equation of seawater - 2010: Calculation and use of thermodynamic properties.
     * Intergovernmental Oceanographic Commission, Manuals and Guides No. 56, UNESCO (English), 196
     * pp. See Table D.4 of this TEOS-10 Manual.
     *
     * <p>.. [2] Millero, F. J., R. Feistel, D. G. Wright, and T. J. McDougall, 2008: The
     * composition of Standard Seawater and the definition of the Reference-Composition Salinity
     * Scale, Deep-Sea Res. I, 55, 50-72. See Eqn. (5.3)
     */
    private static double ATOMIC_WEIGHT = 31.4038218;

    /**
     * This function returns the valence factor of sea salt of Reference Composition, 1.2452898.
     * This valence factor is exact, and follows from the definition of the Reference-Composition
     * Salinity Scale 2008 of Millero et al. (2008). The valence factor is the mole-weighted square
     ...
     * <p>.. [2] Millero, F. J., R. Feistel, D. G. Wright, and T. J. McDougall, 2008: The
     * composition of Standard Seawater and the definition of the Reference-Composition Salinity
     * Scale, Deep-Sea Res. I, 55, 50-72. See Eqn. (5.9).
     */
     ...
     *
     * <p>From: UNESCO Tech Paper Mar Sci 44 (1983)
     *
     * @param salinity (psu)
    ...
    public static double atg(double salinity, double temperature, double pressure) {
        ...
        return A0
                + (A1 + (A2 + A3 * temperature) * temperature) * temperature
                + (B0 + B1 * temperature) * (salinity - (35D))
                + (C0
                                + (C1 + (C2 + C3 * temperature) * temperature) * temperature
                                + (D0 + D1 * temperature) * (salinity - (35D)))
                        * pressure
                + ((E0 + (E1 + E2 * temperature) * temperature)) * pressure * pressure;
    }
    ...
    public static double bulkmod(double salinity, double temperature, double pressure) {
        ...
        double KW =
                E0
                        + (E1 + (E2 + (E3 + E4 * temperature) * temperature) * temperature)
                                * temperature; // eq 19
        ...
        double A =
                AW
                        + (I0 + (I1 + I2 * temperature) * temperature) * salinity
                        + J0 * salinity * Math.sqrt(salinity); // eq 17
    ...
    public static double delta(double salinity, double temperature, double pressure) {
        return 1.0E5
                * (1 / density(salinity, temperature, pressure) - 1 / density(35, 0, pressure));
    }
     ...
     *
     * <p>International Equation of State of Seawater (1980) UNESCO Tech Paper Mar Sci 44 (1983)
     *
     * <p>Example: density(34.567,5.00,2000) -> 1.036409 density(35,25,10000) -> 1.06253817 UNESCO
     * 44 p19
     *
    ...
    /**
     * Seawater density (S, T, 0) International Equation of State of Seawater (1980) UNESCO Tech
     * Paper Mar Sci 44 (1983)
     *
     * @param S = salinity psu
     * @param T = temperature C
     * @return density (kg/liter)
     ...
     *
     * <p>Example: depth_(5000,36) -> 4906.08<br>
     * depth_(1000,90) -> 9674.23 UNESCO 44 p28<br>
     * <br>
     *
     * <p>Note: For more accurate results an additional factor of the ratio of the actual
     * geopotential anomaly/gravity must be added. This correction will be less than 2 m.<br>
     *
     * @param pressure dbar
     ...
     *
     * <p>TODO: Create unit test freeze(33, 0) -> -1.808 freeze(35,500) -> -2.299 UNESCO 44 p30
     *
    ...
    /**
     * Conversion of conductivity ratio to practical salinity (R, T, P) UNESCO Tech Paper Mar Sci 44
     * (1983)
     *
    ...
    public static double salinity(double conductivity, double temperature, double pressure) {
        ...
        double rt =
                c[0]
                        + (c[1] + (c[2] + (c[3] + c[4] * temperature) * temperature) * temperature)
                                * temperature; // eq 3
        double dd =
                1
                        + (d[0] + d[1] * temperature) * temperature
                        + (d[2] + d[3] * temperature) * conductivity;
        ...
        double s =
                a[0]
                        + (a[1] + (a[2] + (a[3] + (a[4] + a[5] * rrt) * rrt) * rrt) * rrt) * rrt
                        + delS; // eq 1
    ...
    /**
     * Computes the potential density anomaly sigma-t International Equation of State of Seawater
     * (1980) UNESCO Tech Paper Mar Sci 44 (1983)
     *
     * @param salinity psu
     * @param temperature Celsius
     ...
     *
     * <p>Spiceness is orthogonal to isopycnals of potential density
     *
     * <p>Algorithmn from P. Flament, Subduction and finestructure associated with upwelling
     * filaments. Ph. D. Dissertation. University of California, San Diego. Vol 32. No.10. pp.1195
     * to 1207. 1985
     *
     * @param salinity psu
    ...
    public static double svel(double salinity, double temperature, double pressure) {
        ...
        double a =
                a00
                        + (a01 + (a02 + (a03 + a04 * temperature) * temperature) * temperature)
                                * temperature
                        + ((a10
                                                + (a11
                                                                + (a12
    ...
    /**
     * Local potential temperature at the reference pressure = f(S, T, P) UNESCO Tech Paper Mar Sci
     * 44 (1983)
     *
     * @param salinity psu
     * @param temperature Celsius
